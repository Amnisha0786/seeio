...
const ComplaintsIncidentModal = ({ onCancel, topic, open, ...props }: IProps) => {
...
ComplaintsIncidentModal.displayName = "ComplaintsIncidentModal"

export default ComplaintsIncidentModal
