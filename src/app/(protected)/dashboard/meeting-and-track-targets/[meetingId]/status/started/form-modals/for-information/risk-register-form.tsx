...
const RiskRegisterFrom = forwardRef(({ formik }: any, ref) => {
  const { topic, presenter, discussion, notes, documents } = formik.values
...
RiskRegisterFrom.displayName = 'RiskRegisterFrom'

export default RiskRegisterFrom
