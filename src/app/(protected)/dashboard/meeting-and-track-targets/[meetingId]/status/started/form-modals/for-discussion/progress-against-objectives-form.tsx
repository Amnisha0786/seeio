...
const ProgressAgainstObjectivesForm = forwardRef(({ formik }: any, ref) => {
...
ProgressAgainstObjectivesForm.displayName = 'ProgressAgainstObjectivesForm'

export default ProgressAgainstObjectivesForm
