...
const AdditionalInformationItem = forwardRef(({ formik }: any, ref) => {
  const { topic, presenter, discussion, minutes, notes, documents } =
    formik.values
...
AdditionalInformationItem.displayName = 'AdditionalInformationItem'
