          ...
          <FlexBox justifyContent="space-between" className={styles.content}>
            <FlexBox flexDirection="column" className={styles.content}>
              ...
              <Typography size='large'>
                {data?.documentDate ? moment(data?.documentDate).format('DD/MM/YYYY') : "-"}
              </Typography>
            </FlexBox>
            ...
            <FlexBox flexDirection="column" className={styles.content}>
              ...
              <Space size={5} />
              <Typography size='large'>
                {data?.reviewDate ? moment(data?.reviewDate).format('DD/MM/YYYY') : "-"}
              </Typography>
            </FlexBox>
            ...
            <FlexBox flexDirection="column" className={styles.content}>
              ...
              <Space size={5} />
              <Typography size='large'>
                {data?.lastReview ? moment(data?.lastReview).format('DD/MM/YYYY') : "-"}
              </Typography>
            </FlexBox>
          </FlexBox>
          <Space size={25} />
...
export default OtherDocumentViewCard;
